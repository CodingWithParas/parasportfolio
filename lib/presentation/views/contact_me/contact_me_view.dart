...
class _GetInTouchPageState extends State<GetInTouchPage>
  ...
  Widget build(BuildContext context) {
    return <Widget>[
      ...
      <Widget>[
        Text('Hello! User'.prefixSlash(),style: context.adaptive(Theme.of(context).textTheme.bodySmall,Theme.of(context).textTheme.bodyMedium),),
        verticalSpaceMedium,
        Text(
          'Get In Touch !',
          ...
          Text(
            hasError
                ? (_contactVM.error.isEmpty
                    ...
                    : _contactVM.error)
                : "Error!! send mail - paras.influxinfotech@gmail.com",
            style: context
